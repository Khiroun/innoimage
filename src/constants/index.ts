...
export const transformationTypes = {
  ...
  fill: {
    ...
    subTitle:
      "Améliorez les dimensions d'une image à l'aide de l'outpainting IA",
...
export const aspectRatioOptions = {
  ...
  "9:16": {
    aspectRatio: "9:16",
    label: "Portrait au téléphone (9:16)",
    width: 1000,
    height: 1778,
  },
};
